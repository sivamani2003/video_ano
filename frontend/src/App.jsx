    ...
    <div className="flex flex-col items-center p-4 space-y-4">
      <div className="relative w-[600px]">
        <video
          ...
          className="rounded-lg shadow-lg"
        />
        <div className="absolute top-4 left-4 text-white text-2xl font-bold shadow-text">{text}</div>
        <input
  type="text"
  value={text}
  onChange={handleTextChange}
  placeholder="Enter your text"
  className="px-2 py-1 mt-4 w-full rounded border border-black"
/>
      ...
      <div className="flex space-x-4">
        ...
        <button
          ...
          className={`px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 ${
            processing ? 'cursor-not-allowed bg-gray-500' : ''
          }`}
        >
          {processing ? 'Processing...' : 'Download Video with Text'}
        </button>
